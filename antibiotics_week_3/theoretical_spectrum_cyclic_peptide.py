...
- The key trick for cycles: for every "interior" subpeptide (one that
  ...
  start). Its mass is simply:
      total_mass - (PrefixMass[j] - PrefixMass[i])
...
if __name__ == "__main__":
    peptide = read_peptide("theoretical_spectrum.txt")
